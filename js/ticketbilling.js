        ...
        click: function () {
            if (this.status() == 'available') {
                ...
                if($(".price_single").length>5){
                  ...
                  $("#seat_to_ticket").append("<ul class='seat_ticket_single' id='stt_"+val+"'><li><a>SEAT</a><a> "+seat_row + seat_column+"</a></li><li>&#163;<a style='color:#A6792C;font-size:1.1em;' class='price_single'>"+this.data().price+"</a></li></ul>");
                  if($(".price_single")){
